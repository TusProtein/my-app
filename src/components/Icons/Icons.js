...
export const IconInbox = ({ className, width = "2rem", height = "2rem" }) => {
  return (
    <svg
      className={className}
      width={width}
...
export const IconLoading = ({ width = "1rem", height = "1rem", className }) => {
  return (
    <svg
